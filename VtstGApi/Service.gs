...
/**
 * Sets the format of the returned token. Default: OAuth2_.TOKEN_FORMAT.JSON.
 * @param {OAuth2_.TOKEN_FORMAT} tokenFormat The format of the returned token.
 * @return {Service_} This service, for chaining.
 */
...
Service_.prototype.getAuthorizationUrl = function() {
  ...
  var redirectUri = OAuth2_.getRedirectUri(this.projectKey_);
